...
const YOLOPOSE_CONFIGS: Record<YOLOPoseSize, YOLOPoseConfig> = {
  nano: {
    size: 'nano',
    inputSize: 640,
    modelPath: 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8n-pose.onnx',
    modelSizeMB: '~6MB',
    expectedFPS: 100,
  },
  small: {
    size: 'small',
    inputSize: 640,
    modelPath: 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8s-pose.onnx',
    modelSizeMB: '~12MB',
    expectedFPS: 70,
  },
  medium: {
    size: 'medium',
    inputSize: 640,
    modelPath: 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8m-pose.onnx',
    modelSizeMB: '~26MB',
    expectedFPS: 45,
  },
  large: {
    size: 'large',
    inputSize: 640,
    modelPath: 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8l-pose.onnx',
    modelSizeMB: '~44MB',
    expectedFPS: 30,
  },
  xlarge: {
    size: 'xlarge',
    inputSize: 640,
    modelPath: 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8x-pose.onnx',
    modelSizeMB: '~70MB',
    expectedFPS: 20,
  },
};
